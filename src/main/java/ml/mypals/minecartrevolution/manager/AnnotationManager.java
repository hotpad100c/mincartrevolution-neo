...
/**
 * This is a class to simplify when finding annotation targets
 * It can simply just create a new instance and run "find()" to find annotation targets
 * It can help you simplify some registry things, so that you don't need to manually register
 * @author Mulatram
 */
public class AnnotationManager {
    ...
    public List<ModFileScanData.AnnotationData> find() {
        ...
        scanData.forEach(
                scan -> scan.getAnnotatedBy(annotation,target).forEach(ret::add)
        );
        return ret;
    }
}
