...
public class MinecartChainManager {
  ...
  public static boolean createChain(
      ServerLevel level, AbstractMinecart cartA, AbstractMinecart cartB) {
    ...
    ChainEntity chain =
        new ChainEntity(chainEntityTypeSupplier.get(), level, cartA.getUUID(), cartB.getUUID());
