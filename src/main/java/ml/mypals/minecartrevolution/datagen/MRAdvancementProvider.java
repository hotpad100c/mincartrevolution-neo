...
public class MRAdvancementProvider {
  ...
  private static final Identifier BG_TEXTURE =
      Identifier.fromNamespaceAndPath(MODID, "gui/advancements/backgrounds/advancements");
  ...
  private static AdvancementHolder craftAdv(
    ...
    return Advancement.Builder.advancement()
        ...
        .addCriterion(
            "craft_" + id,
            MRModCriteria.BLOCK_CART_CRAFTED
                .get()
                .createCriterion(
                    new BlockCartCraftedCriterion.Conditions(
                        Optional.empty(), descriptionId, false)))
        .save(saver, id);
  }

  public static void generate(
      HolderLookup.@NotNull Provider registries, @NotNull Consumer<AdvancementHolder> saver) {

    HolderGetter<EntityType<?>> entityTypes = registries.lookupOrThrow(Registries.ENTITY_TYPE);

    // ─── ROOT ────────────────────────────────────────────────────────────
    AdvancementHolder getBlockMinecart =
    ...
    // ─── JUKEBOX BRANCH ──────────────────────────────────────────────────
    AdvancementHolder getJukeboxMinecart =
        craftAdv(
            getBlockMinecart,
    ...
    AdvancementHolder jukeboxMinecartMoved =
        Advancement.Builder.advancement()
            ...
            .display(
                ...
                true)
            .addCriterion(
                "move_on_jukebox_minecart",
                MRModCriteria.ENTITY_MOVED
                    .get()
                    .createCriterion(
                        new MovingOnJukeboxCartCriterion.Conditions(
                            Optional.empty(),
                            MRMinecarts.JUKEBOX_MINECART.entity().get().getDescriptionId())))
    ...
    // ─── DRAGON EGG BRANCH ───────────────────────────────────────────────
    AdvancementHolder getDragonEggMinecart =
        Advancement.Builder.advancement()
    ...
    AdvancementHolder getDangerousMinecart =
        Advancement.Builder.advancement()
            .parent(getBlockMinecart)
            .display(
                MRMinecarts.CACTUS_MINECART.item().get(),
    ...
    // ─── RAIL / BABEL BRANCH ─────────────────────────────────────────────
    AdvancementHolder isThatBabelTower =
        Advancement.Builder.advancement()
            .parent(getBlockMinecart)
            .display(
                ...
                false)
            .addCriterion(
                "is_that_babel_tower_criterion", BabelTowerCriterion.TriggerInstance.trigger())
    ...
    // ─── SPONGE BRANCH ───────────────────────────────────────────────────
    AdvancementHolder getSpongeMinecart =
        craftAdv(
            getBlockMinecart,
    ...
    Advancement.Builder.advancement()
        ...
        .display(
            Blocks.WET_SPONGE,
            title("sponge_absorbed"),
            desc("sponge_absorbed"),
            null,
            AdvancementType.CHALLENGE,
            true,
            true,
            false)
        .addCriterion(
            "sponge_absorbed_criterion", SpongeAbsorbedCriterion.TriggerInstance.spongeAbsorbed())
        .save(saver, "sponge_absorbed");

    // ─── CONTAINER MINECART BRANCH ───────────────────────────────────────
    AdvancementHolder getBarrelMinecart =
        craftAdv(
            getBlockMinecart,
    ...
    AdvancementHolder getShulkerMinecart =
        craftAdv(
            getBlockMinecart,
    ...
    // ─── BEACON BRANCH ───────────────────────────────────────────────────
    AdvancementHolder getBeaconMinecart =
        craftAdv(
            getBlockMinecart,
    ...
    Advancement.Builder.advancement()
        ...
        .display(
            Blocks.BEACON,
            title("beacon_activated"),
            desc("beacon_activated"),
            null,
            AdvancementType.CHALLENGE,
            true,
            true,
            false)
        .addCriterion(
            "beacon_activated_criterion",
            BeaconActivatedCriterion.TriggerInstance.beaconActivated())
        .save(saver, "beacon_activated");

    // ─── HONEY BRANCH ────────────────────────────────────────────────────
    AdvancementHolder getHoneyMinecart =
        craftAdv(
            getBlockMinecart,
    ...
    // ─── PORTAL BRANCH ───────────────────────────────────────────────────
    AdvancementHolder getPortalMinecart =
        craftAdv(
            getBlockMinecart,
    ...
    Advancement.Builder.advancement()
        ...
        .display(
            Items.ENDER_PEARL,
            title("portal_teleport"),
            desc("portal_teleport"),
            null,
            AdvancementType.CHALLENGE,
            true,
            true,
            false)
        .addCriterion(
            "portal_teleport_criterion",
            PortalMinecartTeleportCriterion.TriggerInstance.teleported())
    ...
    AdvancementHolder getAnvilMinecart =
        craftAdv(
            getBlockMinecart,
    ...
    Advancement.Builder.advancement()
        ...
        .display(
            Blocks.ANVIL,
            title("ride_anvil_minecart"),
            desc("ride_anvil_minecart"),
            null,
            AdvancementType.CHALLENGE,
            true,
            true,
    ...
    AdvancementHolder django_unchained =
        Advancement.Builder.advancement()
            .parent(getBlockMinecart)
            .display(
                IRON_CHAIN,
                ...
                true)
            .addCriterion(
                "django_unchained_criterion", DjangoUnchainedCriterion.TriggerInstance.trigger())
