...
public class DjangoUnchainedCriterion
    extends SimpleCriterionTrigger<DjangoUnchainedCriterion.TriggerInstance> {
  @Override
  ...
  public record TriggerInstance(Optional<ContextAwarePredicate> player)
    ...
    public static final Codec<DjangoUnchainedCriterion.TriggerInstance> CODEC =
        RecordCodecBuilder.create(
            i ->
                i.group(
                        EntityPredicate.ADVANCEMENT_CODEC
                            .optionalFieldOf("player")
                            .forGetter(DjangoUnchainedCriterion.TriggerInstance::player))
    ...
    public static Criterion<DjangoUnchainedCriterion.TriggerInstance> trigger() {
      return MRModCriteria.DJANGO_UNCHAINED
          .get()
          .createCriterion(new DjangoUnchainedCriterion.TriggerInstance(Optional.empty()));
    }
  }
}
