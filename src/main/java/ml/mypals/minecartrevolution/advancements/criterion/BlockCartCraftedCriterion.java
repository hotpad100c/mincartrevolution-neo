...
public class BlockCartCraftedCriterion
    extends SimpleCriterionTrigger<
        BlockCartCraftedCriterion.@org.jetbrains.annotations.NotNull Conditions> {
  ...
  public record Conditions(
      ...
      String entityTranslateId,
      boolean anythingIsOk)
            ...
            instance ->
                instance
                    .group(
                        ...
                        Codec.BOOL
                            .optionalFieldOf("anything_is_ok", false)
                            .forGetter(Conditions::anythingIsOk))
