...
public class BabelTowerCriterion
    extends SimpleCriterionTrigger<BabelTowerCriterion.TriggerInstance> {
  ...
  public record TriggerInstance(Optional<ContextAwarePredicate> player)
    ...
    public static final Codec<BabelTowerCriterion.TriggerInstance> CODEC =
        RecordCodecBuilder.create(
            i ->
                i.group(
                        EntityPredicate.ADVANCEMENT_CODEC
                            .optionalFieldOf("player")
                            .forGetter(BabelTowerCriterion.TriggerInstance::player))
    ...
    public static Criterion<TriggerInstance> trigger() {
      return MRModCriteria.IS_THAT_BABEL_TOWER
          .get()
          .createCriterion(new BabelTowerCriterion.TriggerInstance(Optional.empty()));
    }
  }
}
