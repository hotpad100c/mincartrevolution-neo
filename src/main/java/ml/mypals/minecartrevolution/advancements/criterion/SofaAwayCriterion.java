...
public class SofaAwayCriterion extends SimpleCriterionTrigger<SofaAwayCriterion.TriggerInstance> {
  ...
  public record TriggerInstance(Optional<ContextAwarePredicate> player)
    ...
    public static final Codec<SofaAwayCriterion.TriggerInstance> CODEC =
        RecordCodecBuilder.create(
            i ->
                i.group(
                        EntityPredicate.ADVANCEMENT_CODEC
                            .optionalFieldOf("player")
                            .forGetter(SofaAwayCriterion.TriggerInstance::player))
    ...
    public static Criterion<TriggerInstance> sofaAway() {
      return MRModCriteria.SOFA_AWAY
          .get()
          .createCriterion(new SofaAwayCriterion.TriggerInstance(Optional.empty()));
    }
  }
}
