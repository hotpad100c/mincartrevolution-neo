...
public class BabelCriterion extends SimpleCriterionTrigger<BabelCriterion.TriggerInstance> {
  ...
  public record TriggerInstance(Optional<ContextAwarePredicate> player)
    ...
    public static final Codec<BabelCriterion.TriggerInstance> CODEC =
        RecordCodecBuilder.create(
            i ->
                i.group(
                        EntityPredicate.ADVANCEMENT_CODEC
                            .optionalFieldOf("player")
                            .forGetter(BabelCriterion.TriggerInstance::player))
    ...
    public static Criterion<TriggerInstance> trigger() {
      return MRModCriteria.BABEL
          .get()
          .createCriterion(new BabelCriterion.TriggerInstance(Optional.empty()));
    }
  }
}
