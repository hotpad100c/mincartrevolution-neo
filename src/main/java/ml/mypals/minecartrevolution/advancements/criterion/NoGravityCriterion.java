...
public class NoGravityCriterion extends SimpleCriterionTrigger<NoGravityCriterion.TriggerInstance> {
  ...
  public record TriggerInstance(Optional<ContextAwarePredicate> player)
    ...
    public static final Codec<NoGravityCriterion.TriggerInstance> CODEC =
        RecordCodecBuilder.create(
            i ->
                i.group(
                        EntityPredicate.ADVANCEMENT_CODEC
                            .optionalFieldOf("player")
                            .forGetter(NoGravityCriterion.TriggerInstance::player))
    ...
    public static Criterion<TriggerInstance> noGravity() {
      return MRModCriteria.NO_GRAVITY
          .get()
          .createCriterion(new NoGravityCriterion.TriggerInstance(Optional.empty()));
    }
  }
}
