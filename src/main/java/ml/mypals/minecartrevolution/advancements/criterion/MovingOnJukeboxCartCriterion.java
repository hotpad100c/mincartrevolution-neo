...
public class MovingOnJukeboxCartCriterion
    extends SimpleCriterionTrigger<
        MovingOnJukeboxCartCriterion.@org.jetbrains.annotations.NotNull Conditions> {
  ...
  public record Conditions(
      Optional<ContextAwarePredicate> playerPredicate, String entityTranslateId)
