...
public class PickerMinecartRenderer extends AbstractMinecartRenderer<PickerMinecartEntity, MinecartRenderState> {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(MinecartRevolution.MODID, "textures/entity/minecart/picker_minecart.png");
    ...
    public void submit(@NonNull MinecartRenderState state, @NonNull PoseStack poseStack, @NonNull SubmitNodeCollector submitNodeCollector, @NonNull CameraRenderState camera) {
