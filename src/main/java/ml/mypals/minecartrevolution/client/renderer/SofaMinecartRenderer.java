...
import ml.mypals.minecartrevolution.entity.minecarts.SofaMinecart;
...
public class SofaMinecartRenderer extends AbstractMinecartRenderer<SofaMinecart, SofaMinecartRenderState> {
    ...
    @Override
    public void extractRenderState(@NonNull SofaMinecart entity, @NonNull SofaMinecartRenderState state, float partialTicks) {
