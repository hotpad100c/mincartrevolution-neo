...
public class ShulkerMinecartRenderer extends AbstractMinecartRenderer<ShulkerMinecartEntity, ShulkerMinecartRenderState> {
    ...
    @Override
    public void extractRenderState(@NonNull ShulkerMinecartEntity entity, @NonNull ShulkerMinecartRenderState state, float partialTick) {
    ...
    @Override
    protected void submitMinecartContents(ShulkerMinecartRenderState state,
        ...
        SpriteId sprite = (state.color == null) ?
