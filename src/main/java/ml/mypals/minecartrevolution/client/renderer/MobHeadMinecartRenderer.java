...
public class MobHeadMinecartRenderer
    extends AbstractMinecartRenderer<MobHeadMinecartEntity, MobHeadMinecartRenderState> {
  ...
  public MobHeadMinecartRenderer(EntityRendererProvider.Context context) {
    ...
    skullModels.put(
        SkullBlock.Types.PIGLIN, SkullBlockRenderer.createModel(modelSet, SkullBlock.Types.PIGLIN));
    skullModels.put(
        SkullBlock.Types.SKELETON,
        SkullBlockRenderer.createModel(modelSet, SkullBlock.Types.SKELETON));
    skullModels.put(
        SkullBlock.Types.DRAGON, SkullBlockRenderer.createModel(modelSet, SkullBlock.Types.DRAGON));
    skullModels.put(
        SkullBlock.Types.PLAYER, SkullBlockRenderer.createModel(modelSet, SkullBlock.Types.PLAYER));
    skullModels.put(
        SkullBlock.Types.WITHER_SKELETON,
        SkullBlockRenderer.createModel(modelSet, SkullBlock.Types.WITHER_SKELETON));
    skullModels.put(
        SkullBlock.Types.ZOMBIE, SkullBlockRenderer.createModel(modelSet, SkullBlock.Types.ZOMBIE));
  }
