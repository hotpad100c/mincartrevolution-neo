    ...
    private static void renderQuad(
        ...
        for (int i = 0; i < 4; i++) {
            ...
            buffer.addVertex(
                    ...
                    .setColor(-1)
                    .setUv(
                            UVPair.unpackU(quad.packedUV(i)),
                            UVPair.unpackV(quad.packedUV(i)))
