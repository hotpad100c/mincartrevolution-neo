...
public class ChainedJukeboxSoundInstance extends AbstractTickableSoundInstance {
    ...
    public ChainedJukeboxSoundInstance(SoundEvent soundEvent, SoundSource soundSource, float volume, float pitch, JukeboxMinecartEntity jukebox, long seed, List<Integer> connectedAmethysts) {
