...
public class WeightPressurePlateMinecartEntity extends SingleBlockMinecartEntity
    implements PowerEmitterMinecartEntity {
  private static final int MAX_BOUNDING_BOX = 64; // Ghast

  public WeightPressurePlateMinecartEntity(
      EntityType<? extends WeightPressurePlateMinecartEntity> entityType,
      Level world,
      double x,
      double y,
      double z,
  ...
  public WeightPressurePlateMinecartEntity(
      EntityType<WeightPressurePlateMinecartEntity> weightPresherPlateMinecartEntityEntityType,
      Level world) {
  ...
  public int getPowerStrength(Direction direction, BlockPos pos) {
    ...
    if (firstPassenger != null) {
      double size =
          this.getFirstPassenger().getDimensions(firstPassenger.getPose()).height()
