...
public class RailMinecartEntityMapper {
  @MinecartMapper
  public static final Map<Block, BiFunction<Level, Vec3, AbstractMinecart>> RAIL_MINECARTS =
      new HashMap<>();
  ...
  static {
    RAIL_MINECARTS.put(
        Blocks.RAIL,
        (world, pos) ->
            new RailMinecartEntity(
                MRMinecarts.RAIL_MINECART.get(), world, pos.x(), pos.y(), pos.z(), Items.RAIL));
    RAIL_MINECARTS.put(
