...
public class ChestEntityMapper {
  @MinecartMapper
  public static final Map<Block, BiFunction<Level, Vec3, AbstractMinecart>> CHEST_MINECARTS =
      new HashMap<>();
  ...
  static {
    ...
    CHEST_MINECARTS.put(
        ...
        (world, pos) -> {
          AbstractMinecart abstractMinecart =
              new CopperChestMinecartEntity(
                  MRMinecarts.COPPER_CHEST_MINECART.entity().get(), world);
          abstractMinecart.setInitialPos(pos.x, pos.y, pos.z);
          abstractMinecart.setCustomDisplayBlockState(
              Optional.of(Blocks.COPPER_CHEST.defaultBlockState()));
          return abstractMinecart;
        });
    CHEST_MINECARTS.put(
        ...
        (world, pos) -> {
          ...
          abstractMinecart.setInitialPos(pos.x, pos.y, pos.z);
          abstractMinecart.setCustomDisplayBlockState(
              Optional.of(Blocks.EXPOSED_COPPER_CHEST.defaultBlockState()));
          return abstractMinecart;
        });
    CHEST_MINECARTS.put(
        ...
        (world, pos) -> {
          ...
          abstractMinecart.setInitialPos(pos.x, pos.y, pos.z);
          abstractMinecart.setCustomDisplayBlockState(
              Optional.of(Blocks.WEATHERED_COPPER_CHEST.defaultBlockState()));
          return abstractMinecart;
        });
    CHEST_MINECARTS.put(
        ...
        (world, pos) -> {
          ...
          abstractMinecart.setInitialPos(pos.x, pos.y, pos.z);
          abstractMinecart.setCustomDisplayBlockState(
              Optional.of(Blocks.OXIDIZED_COPPER_CHEST.defaultBlockState()));
          return abstractMinecart;
        });
    ...
    CHEST_MINECARTS.put(
        ...
        (world, pos) -> {
          ...
          abstractMinecart.setInitialPos(pos.x, pos.y, pos.z);
          abstractMinecart.setCustomDisplayBlockState(
              Optional.of(Blocks.WAXED_COPPER_CHEST.defaultBlockState()));
          return abstractMinecart;
        });
    CHEST_MINECARTS.put(
        ...
        (world, pos) -> {
          ...
          abstractMinecart.setInitialPos(pos.x, pos.y, pos.z);
          abstractMinecart.setCustomDisplayBlockState(
              Optional.of(Blocks.WAXED_EXPOSED_COPPER_CHEST.defaultBlockState()));
          return abstractMinecart;
        });
    CHEST_MINECARTS.put(
        ...
        (world, pos) -> {
          ...
          abstractMinecart.setInitialPos(pos.x, pos.y, pos.z);
          abstractMinecart.setCustomDisplayBlockState(
              Optional.of(Blocks.WAXED_WEATHERED_COPPER_CHEST.defaultBlockState()));
          return abstractMinecart;
        });
    CHEST_MINECARTS.put(
        ...
        (world, pos) -> {
          ...
          abstractMinecart.setInitialPos(pos.x, pos.y, pos.z);
          abstractMinecart.setCustomDisplayBlockState(
              Optional.of(Blocks.WAXED_OXIDIZED_COPPER_CHEST.defaultBlockState()));
          return abstractMinecart;
        });
  }
}
