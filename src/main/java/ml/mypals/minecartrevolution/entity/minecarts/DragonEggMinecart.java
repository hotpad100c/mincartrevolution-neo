...
public class DragonEggMinecart extends SingleBlockMinecartEntity {
  ...
  public void activateMinecart(@NonNull ServerLevel level, int x, int y, int z, boolean powered) {
    ...
    chunkManager.addTicketAndLoadWithRadius(
        TicketType.DRAGON, ChunkPos.containing(this.blockPosition()), 2);
  ...
  public boolean hurtServer(
      @NonNull ServerLevel level, @NonNull DamageSource source, float damage) {
