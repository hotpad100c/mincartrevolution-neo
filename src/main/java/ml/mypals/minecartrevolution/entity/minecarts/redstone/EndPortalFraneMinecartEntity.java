...
public class EndPortalFraneMinecartEntity extends RedstoneBlockMinecartEntity
    implements PowerEmitterMinecartEntity {
  private int entitiesAbove = 0;

  public EndPortalFraneMinecartEntity(
      EntityType<? extends @NotNull EndPortalFraneMinecartEntity> entityType, Level world) {
  ...
  public void tick() {
    ...
    if (level().getGameTime() % 5 == 0) {
      int entitiesAboveNow =
          level().getEntities(this, this.getBoundingBox().inflate(0, 15, 0)).size();
