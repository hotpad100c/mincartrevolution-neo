...
public class NetherPortalCreationMixin {
    ...
    public void createPortalBlocks(LevelAccessor level, Operation<Void> original) {
        Iterable<BlockPos> portals = BlockPos.betweenClosed(this.bottomLeft, this.bottomLeft.relative(Direction.UP, this.height - 1).relative(this.rightDir, this.width - 1));
        original.call(level);
